...
// Portable single-readerOfEntries, single-writerToComponentB semaphore below:
		...
		private:
		    ...
		    bool waitWithPartialSpinning(std::int64_t timeout_usecs = -1) AE_NO_TSAN
		    {
				...
				while (true)
				{
					...
					// Oh, the readerOfEntries thread just signaled the semaphore after all. Try again:
					oldCount = m_count.fetch_add_acquire(-1);
